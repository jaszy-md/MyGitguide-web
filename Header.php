...
<section id="home">
    <div class="sub_header"> 
        ...
        <p class="info">
            <i class="material-icons-outlined">call</i> +31612345678 
            <span><i class="material-icons-outlined email-icon">mail_outline</i> MyFitGuide@gmail.com</span>
        </p>

        <div class="mobile-icons">
            <i class="material-icons-outlined">call</i>
            <i class="material-icons-outlined email-icon">mail_outline</i>
        </div>
    </div>
